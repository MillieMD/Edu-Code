...
CREATE TABLE `studentinclass` (
  ...
  CONSTRAINT `studentinclass_ibfk_1` FOREIGN KEY (`classID`) REFERENCES `classes` (`classID`),
  CONSTRAINT `studentinclass_ibfk_2` FOREIGN KEY (`studentID`) REFERENCES `users` (`userID`)
